...
|---|---|---|---|---|
| 2026-08-12 | Built | [Deactivation Ends the Session](./2026-08-12-deactivation-ends-the-session.md) | Auth / Admin | Deactivating a staff account now cuts off access on the next request instead of after the 30-day token expires, and the person is told why the account can no longer be used. |
